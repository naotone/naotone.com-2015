...
var _modulesParticle = require('./modules/Particle');

var _modulesParticle2 = _interopRequireDefault(_modulesParticle);
...
var App = (function () {
  function App() {
    ...
    this.three = new _modulesParticle2['default']();
    this.three.init();
    this._bindEvents();
  }
...
},{"./modules/Particle":4,"./modules/Util":6}],3:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.18.0
 * DATE: 2015-09-05
  ...
  _createClass(Transition, [{
    ...
    value: function _start(flyingParticles) {
      ...
      for (var i = 0; i < flyingParticles.length; i++) {
        ...
        _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.position, 0.6, {
...
var Objects = (function () {
  function Objects(color, shape, texture) {
...
var Particle = (function (_Scene) {
  _inherits(Particle, _Scene);
  ...
  _createClass(Particle, [{
    ...
    value: function _initScene() {
      _get(Object.getPrototypeOf(Particle.prototype), '_initScene', this).call(this);
    }
  }, {
    key: '_initCamera',
    value: function _initCamera() {
      _get(Object.getPrototypeOf(Particle.prototype), '_initCamera', this).call(this);
    }
  }, {
    key: '_initLights',
    value: function _initLights() {
      _get(Object.getPrototypeOf(Particle.prototype), '_initLights', this).call(this);
    }
  }, {
    key: '_initGeometry',
    value: function _initGeometry() {
      _get(Object.getPrototypeOf(Particle.prototype), '_initGeometry', this).call(this);
      this._initLoading();
    }
  }, {
    key: '_animate',
    value: function _animate() {
      _get(Object.getPrototypeOf(Particle.prototype), '_animate', this).call(this);
      var time = this.clock.getElapsedTime();
      if (!bLoading && bPjax) {
        console.log(11);
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.loading.scale, 0.2, {
          x: 0.00001,
          z: 0.00001,
          ease: Cubic.In
        });
        ...
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.loading.scale, 0.4, {
          x: 7,
          y: 7,
          ease: Cubic.In
        });
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.camera.position, 0.4, {
          x: 0.5,
          y: 0.5,
          ease: Cubic.In
        });
    ...
    value: function _render() {
      _get(Object.getPrototypeOf(Particle.prototype), '_render', this).call(this);
    }
  }, {
    key: '_initLoading',
    value: function _initLoading() {
      ...
      _libsGreensockSrcUncompressedTweenMax2['default'].to(this.loading.rotation, 5, {
        x: Math.PI,
        y: Math.PI,
        z: Math.PI,
    ...
    key: '_flyParticle',
    value: function _flyParticle(p) {
      var _this2 = this;

      var thisMesh = p.mesh;
      var s = p.mesh.scale.x;
      var duration = Math.max(p.mesh.scale.x * 6, 4);
      _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.rotation, duration, {
        x: s * 4 * Math.random(),
        y: s * 4 * Math.random(),
        z: s * 4 * Math.random(),
        ease: Quart.out
      });
      _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.position, duration, {
        x: p.mesh.position.x * 2,
        y: p.mesh.position.y * 2,
        z: 3000,
        ease: Strong.QuartInOut,
        onComplete: function onComplete() {
          _this2.scene.remove(thisMesh);
          p.mesh.material.dispose();
          _this2.flyingParticles.shift();
        },
        onCompleteParams: [p]
      });
    }
    ...
    value: function _loadTex(id) {
      ...
      for (var i = 0; i < this.flyingParticles.length; i++) {
        ...
        var s = p.mesh.scale.x;
        var duration = 2;
        _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.position, .6, {
          x: p.mesh.position.x * 3,
          y: p.mesh.position.y * 3,
          z: 3000,
          ease: Cubic.In
      ...
      _libsGreensockSrcUncompressedTweenMax2['default'].to(this.cube.position, duration, {
        x: 200,
        ease: Cubic.In
      });
      _libsGreensockSrcUncompressedTweenMax2['default'].to(this.cube.scale, duration, {
        x: 5,
        y: 5,
        z: 5,
        ease: Cubic.In
      });
      _libsGreensockSrcUncompressedTweenMax2['default'].to(this.cube.rotation, duration, {
        x: Math.PI * 2,
        y: Math.PI * 2,
        z: -Math.PI * 2,
        ease: Linear.easeNone,
    ...
    key: '_removeTex',
    value: function _removeTex() {
      _libsGreensockSrcUncompressedTweenMax2['default'].to(this.cube.position, .5, {
        z: 3500,
        ease: Cubic.In
      });
      ...
      for (var i = 0; i < this.flyingParticles.length; i++) {
        ...
        p.material.map = '';
        _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.scale, .3, {
          x: .3 + s,
          y: .3 + s,
          z: .3 + s,
          ease: Cubic.Out
...
},{"../libs/greensock/src/uncompressed/TweenMax":3,"./Scene":5,"./Util":6}],5:[function(require,module,exports){
'use strict';
...
var Scene = (function () {
  function Scene() {
    ...
    this.mouseX = null;
    this.mouseY = null;
    this.colors = ['ffffff', 'EA6A63', '61D0EA', 'EAA760', 'EEEEEE', '777777'], this.counter = 0;
...
},{"../three/Detector":7,"../three/Stats":8}],6:[function(require,module,exports){
'use strict';
