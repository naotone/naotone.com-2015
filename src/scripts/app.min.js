...
var Space = (function (_Scene) {
  ...
  _createClass(Space, [{
    ...
    value: function _start(el) {
      ...
      console.log(~ ~rand);
      if (~ ~rand % 4 == 0) {
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.earth.position, 3, {
          z: 5000,
          delay: 1,
          ease: Strong.CubicIn
        });
      ...
      if (~ ~rand % 5 == 0) {
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.ice.mesh.position, 3, {
          z: 5000,
          delay: 1.4,
          ease: Strong.CubicIn
        });
      ...
      if (~ ~rand % 6 == 0) {
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.fire.mesh.position, 3, {
          z: 5000,
          delay: 1.1,
          ease: Strong.CubicIn
        });
      ...
      if (~ ~rand % 7 == 0) {
        _libsGreensockSrcUncompressedTweenMax2['default'].to(this.sea.mesh.position, 3, {
          z: 5000,
          delay: 1.6,
          ease: Strong.CubicIn
        });
