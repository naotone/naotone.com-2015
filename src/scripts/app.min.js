...
var _modulesSpace = require('./modules/Space');

var _modulesSpace2 = _interopRequireDefault(_modulesSpace);

var _modulesStyle = require('./modules/Style');

var _modulesStyle2 = _interopRequireDefault(_modulesStyle);

var _modulesUtil = require('./modules/Util');
...
var App = (function () {
  function App() {
    ...
    this.three = new _modulesSpace2['default']();
    this.style = new _modulesStyle2['default']();
    this.three.init();
    this._onResize();
    this._bindEvents();
  }
  ...
  _createClass(App, [{
    ...
    value: function _bindEvents() {
      ...
      var transitionTrigger = document.querySelectorAll('nav a, h1 a');

      window.addEventListener('resize', function (el) {
        _this._onResize(el);
      });
      window.addEventListener('popstate', function () {
        _this.three._popstate();
      });

      for (var i = 0; i < transitionTrigger.length; i++) {
        transitionTrigger[i].addEventListener('click', function (el) {
          _this.three._start(el);
        }, false);
      }

      for (var i = 0; i < projects.length; i++) {
        projects[i].addEventListener((0, _modulesUtil.MouseOn)(), function (el) {
          _this.three._initThumbnail(el);
        });
        projects[i].addEventListener((0, _modulesUtil.MouseOff)(), function () {
          _this.three._removeThumbnail();
        }, false);
        projects[i].addEventListener('click', function (el) {
          _this.three._start(el);
        }, false);
      }

      document.addEventListener('pjax:complete', function () {
        _this.three._complete();
...
},{"./modules/Space":10,"./modules/Style":12,"./modules/Util":13}],3:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.18.0
 * DATE: 2015-09-05
...
var Cube = (function () {
  ...
  _createClass(Cube, [{
    ...
    key: "_initCube",
    value: function _initCube(texture, camera) {
      var project = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

      var scale = 200;

      // const scale = 0.00001
      var geometry = new THREE.BoxGeometry(scale, scale, 1);
...
var LoadingPanel = (function () {
  ...
  _createClass(LoadingPanel, [{
    ...
    value: function _initLoading() {
      ...
      this.textureLoader.load([this.image], function () {
    ...
    value: function _getObjects() {
      ...
      return new Promise(function (resolve, reject) {
        _this2.loadingManager.onLoad = function () {
          resolve(_this2.mesh);
        };
      });
    }
...
var Meteor = function Meteor(color, shape, texture) {
...
var Meteors = (function () {
  function Meteors() {
    ...
    this.colors = ['ffffff', 'ffffff', 'eeeeee', 'eeeeee', 'eeeeee', 'EA6A63', '61D0EA', 'EAA760'], this.flyingParticles = [];
    this.counter = 0;
    this.Height = window.innerHeight;
    this.Width = window.innerWidth;
  }
  ...
  _createClass(Meteors, [{
    ...
    key: '_createParticle',
    value: function _createParticle(p) {
      p.mesh.material.needsUpdate = true;

      if (_Space.bThumbnail == false) {
      ...
      _Space.bParticles == true ? this._flyParticle(p) : this._flyParticle(p, 'fast');
      return p.mesh;
    }
  }, {
    key: '_flyParticle',
    value: function _flyParticle(p, mode) {
      var thisMesh = p.mesh;
      var scale = thisMesh.scale.x * Math.random() * 7;
      var duration = 4;
      var scaleDuration = 1;
      var rotate = Math.random() > 0.5 ? scale : -scale;
    ...
    key: '_updateParticlesLoad',
    value: function _updateParticlesLoad() {
      var shape = Math.random();
      var color = (0, _Util.GetColor)(this.colors, '#');
      var texture = _Space.thumbnail;
...
},{"./Space":10,"./Util":13}],7:[function(require,module,exports){
'use strict';
...
var Planet = (function () {
  function Planet(type, radius, detail) {
  ...
  _createClass(Planet, [{
    ...
    value: function _initPlanet() {
      ...
      for (var i = 0; i < this.mesh.geometry.faces.length; i++) {
        var col = (0, _Util.GetColor)(this.colors, '0x');
...
var _threeDetector = require('../three/Detector');

var _threeDetector2 = _interopRequireDefault(_threeDetector);

var _threeStats = require('../three/Stats');

var _threeStats2 = _interopRequireDefault(_threeStats);
...
var Scene = (function () {
  ...
  _createClass(Scene, [{
    ...
    key: '_initClock',
    value: function _initClock() {
      this.clock = new THREE.Clock();
    }
  }, {
    key: '_initRenderer',
    value: function _initRenderer() {
      if (_threeDetector2['default'].webgl) {
      ...
      } else if (_threeDetector2['default'].canvas) {
        ...
        _threeDetector2['default'].addGetWebGLMessage();
      }
    }
  }, {
    key: '_initCamera',
    ...
    key: '_debugStats',
    value: function _debugStats() {
      this.stats = new _threeStats2['default']();
...
},{"../three/Detector":14,"../three/Stats":15,"./Util":13}],10:[function(require,module,exports){
'use strict';
...
var _libsGreensockSrcUncompressedTweenMax = require('../libs/greensock/src/uncompressed/TweenMax');

var _libsGreensockSrcUncompressedTweenMax2 = _interopRequireDefault(_libsGreensockSrcUncompressedTweenMax);
...
var pjaxTime = 1000;
exports.pjaxTime = pjaxTime;
var bPjax = false;
exports.bPjax = bPjax;
var bLoading = true;
exports.bLoading = bLoading;
var bParticles = false;
exports.bParticles = bParticles;
var bThumbnail = false;
exports.bThumbnail = bThumbnail;
var thumbnail = null;
...
var Pjax = (function () {
  ...
  _createClass(Pjax, [{
    ...
    value: function _counter() {
      exports.pjaxTime = pjaxTime += 1;
      if (pjaxTime > 150 && !bPjax) {
        exports.bPjax = bPjax = true;
      }
      requestAnimationFrame(this._counter.bind(this));
    }
  }, {
    key: '_start',
    value: function _start(el, scene, camera, flyingParticles, cubes) {
      var _this = this;

      // console.log('start');
      var target = el.target.href;
      var lcoation = window.location.href.indexOf('works');
      exports.bBox = bBox = false;

      (0, _Util.AddClass)(document.body, 'stopScrolling');
      document.body.addEventListener("touchmove", function (el) {
        if ((0, _Util.HasClass)(document.body, 'stopScrolling')) {
          el.preventDefault();
        }
      }, false);
      // document.body.addEventListener('touchmove', (el) => {el.preventDefault() })

      if (!(0, _Util.HasClass)(el.target, 'project')) {
        var i;

        (function () {
          exports.thumbnail = thumbnail = null;

          var thisScene = scene;
          if (cubes.length > 0) {
            var _loop = function () {
              var cube = cubes[i];
              _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.rotation, 1, {
                // x: 0.1,
                y: Math.PI,
                // z: 0.1,
                ease: Strong.CubicIn,
              ...
              _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.scale, 1, {
                x: 0.001,
                y: 0.001,
                // z: 0.1,
                ease: Strong.CubicIn,
      ...
      if (cubes.length > 0 && !target.indexOf('works') > -1) {
        for (var i = 0; i < cubes.length; i++) {
          ...
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.rotation, 1.5, {
            x: 0,
            y: -Math.PI,
            z: 0,
            ease: Cubic.In
          });
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.position, 1.5, {
            x: 0,
            y: 0,
            z: 2000,
            ease: Cubic.In
          });
          _libsGreensockSrcUncompressedTweenMax2['default'].to(camera.position, 1.5, {
            x: 0,
            y: 0,
            ease: Cubic.In,
            onComplete: function onComplete() {
              exports.bBox = bBox = true;
            }
          });
        }
        ...
        for (var i = 0; i < cubes.length; i++) {
          var cube = cubes[i];
          cube._removeCube().then(function (response) {
            _this.scene.remove(response);
          }, function (error) {});
        }
      } else {
        exports.bBox = bBox = true;
      ...
      exports.bLoading = bLoading = true;
      exports.bParticles = bParticles = false;
      ...
      for (var i = 0; i < flyingParticles.length; i++) {
        ...
        _libsGreensockSrcUncompressedTweenMax2['default'].to(p.mesh.position, 1, {
    ...
    value: function _complete() {
      ...
      exports.bPjax = bPjax = false;
      exports.pjaxTime = pjaxTime = 0;
      this._preLoadImages();
    }
  }, {
    key: '_popstate',
    ...
    value: function _onLoad() {
      var regex = new RegExp('http[s]?:[/]+.*[/]*([^/]*)\/works\/[a-zA-Z0-9]+\/.*', 'g');
      var regex2 = new RegExp('^http[s]?:[/]+.*[/]*([^/]*)\/works\/secret[/]$', 'g');
      var target = window.location.href;
      if (target.match(regex) && !target.match(regex2)) {
        var project = target.match(".+/(.+?)([\?#;].*)?$")[1].replace('/', '');
        var _thumbnail = '/images/' + project + '.jpg';
        return _thumbnail;
      }
    }
  }, {
      ...
      if (projects.length > 0) {
        ...
        (function () {
          ...
          textureManager.onLoad = function () {
            exports.bLoading = bLoading = false;
...
var Space = (function (_Scene) {
  _inherits(Space, _Scene);
  ...
  function Space() {
    ...
    this.earthLand = new _Planet2['default']('EarthLand');
    this.earthSea = new _Planet2['default']('EarthSea');
    this.earthCloud = new _Planet2['default']('EarthCloud');
    this.fire = new _Planet2['default']('Fire');
    this.sea = new _Planet2['default']('Sea');
    this.ice = new _Planet2['default']('Ice');
    // this.shuttle = new SpaceShuttle()
    // this.loading = new LoadingPanel()
    this.meteor = new _Meteor.Meteor();
    this.meteors = new _Meteor.Meteors();
  ...
  _createClass(Space, [{
    key: '_start',
    value: function _start(el) {
      this.pjax._start(el, this.scene, this.camera, this.meteors.flyingParticles, this.cube.cubes);

      var rand = Math.random() * 100;

      var planets = [this.earth, this.ice.mesh, this.fire.mesh, this.sea.mesh];
      var planet = planets[Math.floor(Math.random() * planets.length)];

      var positionX = Math.random() > 0.5 ? Math.random() * (this.Width - this.windowHalfX) + this.windowHalfX : -1 * (Math.random() * (this.Width - this.windowHalfX) + this.windowHalfX);
      var positionY = Math.random() > 0.5 ? Math.random() * (this.Height - this.windowHalfY) + this.windowHalfY : -1 * (Math.random() * (this.Height - this.windowHalfY) + this.windowHalfY);

      if (~ ~rand % 1 == 0) {
        planet.position.set(positionX * .7, positionY * .7, -1000);
        _libsGreensockSrcUncompressedTweenMax2['default'].to(planet.position, 3, {
          z: 4000,
    ...
    value: function _popstate() {
      ...
      if (!target.match(regex) || target.match(regex2)) {
        ...
        exports.bBox = bBox = true;
        exports.thumbnail = thumbnail = null;
        exports.bThumbnail = bThumbnail = false;
    ...
    value: function _onLoad() {
      if (this.pjax._onLoad()) {
        exports.thumbnail = thumbnail = this.pjax._onLoad();
        this.scene.add(this.cube._initCube(this.pjax._onLoad(), this.camera, true));
        this.cube.cubes.push(this.cube._getObjects());
      }
      // this.style.init()
    ...
    key: '_initScene',
    value: function _initScene() {
      _get(Object.getPrototypeOf(Space.prototype), '_initScene', this).call(this);
    }
  }, {
    key: '_initCamera',
    value: function _initCamera() {
      _get(Object.getPrototypeOf(Space.prototype), '_initCamera', this).call(this);
    }
  }, {
    key: '_initLights',
    value: function _initLights() {
      _get(Object.getPrototypeOf(Space.prototype), '_initLights', this).call(this);
    }
  }, {
    key: '_initGeometry',
    value: function _initGeometry() {
      _get(Object.getPrototypeOf(Space.prototype), '_initGeometry', this).call(this);
      this._onLoad();
    ...
    key: '_initTween',
    value: function _initTween() {
      _get(Object.getPrototypeOf(Space.prototype), '_initTween', this).call(this);
    }
  }, {
    key: '_initThumbnail',
    value: function _initThumbnail(id) {
      if (this.cube && Modernizr.touch) {
        this.scene.remove(this.cube);
      }
      exports.bThumbnail = bThumbnail = true;
      exports.thumbnail = thumbnail = id.target.dataset.tex;
      ...
      for (var i = 0; i < this.meteors.flyingParticles.length; i++) {
        ...
        var scale = meteor.scale.x;
        var duration = 2;
        _libsGreensockSrcUncompressedTweenMax2['default'].to(meteor.position, .6, {
    ...
    key: '_removeThumbnail',
    value: function _removeThumbnail() {
      var _this3 = this;

      if (bBox) {
        exports.thumbnail = thumbnail = null;
        this.cube._removeCube().then(function (response) {
          _this3.scene.remove(response);
        }, function (error) {});
      }
    }
  }, {
    ...
    value: function _animate() {
      if (!bLoading && bPjax) {
        exports.bParticles = bParticles = true;
        document.getElementById('wrap').style.visibility = 'visible';
        (0, _Util.HasClass)(document.body, 'stopScrolling') ? (0, _Util.RemoveClass)(document.body, 'stopScrolling') : null;
      }
      _get(Object.getPrototypeOf(Space.prototype), '_animate', this).call(this);
    ...
    key: '_render',
    value: function _render() {
      _get(Object.getPrototypeOf(Space.prototype), '_render', this).call(this);
    }
  }]);
...
},{"../libs/greensock/src/uncompressed/TweenMax":3,"./Cube":4,"./LoadingPanel":5,"./Meteor":6,"./Planet":7,"./Raycaster":8,"./Scene":9,"./SpaceShuttle":11,"./Style":12,"./Util":13}],11:[function(require,module,exports){
'use strict';
...
var SpaceShuttle = (function () {
  ...
  _createClass(SpaceShuttle, [{
    ...
    key: '_initShuttle',
    value: function _initShuttle() {
      var _this = this;

      this.loadingManager = new THREE.LoadingManager();
      this.loader = new THREE.JSONLoader(this.loadingManager);
      this.loader.load(this.json, function (geometry, materials) {
        ...
        _this.mesh.scale.set(100, 100, 100);
        _this.mesh.position.x = _this.mesh.position.y = 0;
        _this.mesh.position.z = 2000;
        _this.mesh.rotation.x = 90 * Math.PI / 180;
        _this.mesh.rotation.y = 180 * Math.PI / 180;
        _this.mesh.rotation.z = 0;
      });
    }
  }, {
    key: '_getObjects',
...
var Style = (function () {
  ...
  _createClass(Style, [{
    ...
    key: '_general',
    value: function _general() {
      var _target = arguments.length <= 0 || arguments[0] === undefined ? 'section' : arguments[0];
    ...
    key: '_worksSingle',
    value: function _worksSingle() {
      var header = document.querySelector('header');
      var headerH1 = document.querySelector('header h1');
      var headerA = document.querySelectorAll('header a');
...
var HasClass = function HasClass(el, _class) {
...
var GetColor = function GetColor(colors) {
...
var HexToTgb = function HexToTgb(hex) {
...
exports.HexToTgb = HexToTgb;
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////

var Easing = function Easing(mode, t) {
  switch (mode) {
    case 'linear':
      return t;
      break;
