  ...
  _createClass(App, [{
    ...
    value: function _bindEvents() {
      ...
      for (var i = 0; i < projects.length; i++) {
        projects[i].addEventListener((0, _modulesUtil.MouseOn)(), function (e) {
          _this.three._initThumbnail(e);
        });
...
var Pjax = (function () {
  ...
  _createClass(Pjax, [{
    ...
    key: '_start',
    value: function _start(flyingParticles) {
      console.log('pjaxStart', document.location);
      console.log(this.cube);
      if (document.location.pathname.indexOf('works')) exports.bLoading = bLoading = true;
