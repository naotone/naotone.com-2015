...
var _modulesSpace3 = _interopRequireDefault(_modulesSpace);
...
var App = (function () {
  function App() {
    ...
    this.pjax = new _modulesSpace3['default']();
    this.three.init();
    this._bindEvents();
  }
  ...
  _createClass(App, [{
    ...
    value: function _bindEvents() {
      ...
      var transitionTrigger = document.querySelectorAll('nav a, h1 a, a.pjax');
...
},{"./modules/Space":10,"./modules/Util":12}],3:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.18.0
 * DATE: 2015-09-05
...
var Cube = (function () {
  ...
  _createClass(Cube, [{
    ...
    value: function _initCube(texture, camera) {
      var scale = Math.min(this.windowHalfX, this.windowHalfY) * .7;
...
},{"./Space":10,"./Util":12}],7:[function(require,module,exports){
'use strict';
...
},{"../three/Detector":13,"../three/Stats":14}],10:[function(require,module,exports){
'use strict';
...
var Pjax = (function () {
  ...
  _createClass(Pjax, [{
    ...
    key: '_start',
    value: function _start(el, flyingParticles, cubes) {
      ...
      if (cubes.length > 0 && target.indexOf('works') > -1) {
        for (var i = 0; i < cubes.length; i++) {
          ...
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.rotation, 2, {
            y: 0,
            ease: Cubic.In
          });
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.position, 2, {
            x: 0,
            y: 0,
            ease: Cubic.In
          });
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.material, 2, {
            opacity: 0.5,
            ease: Cubic.In
          });
...
var Space = (function (_Scene) {
  ...
  function Space() {
    ...
    this.shuttle = new _SpaceShuttle2['default']();
    this.loading = new _LoadingPanel2['default']();
  ...
  _createClass(Space, [{
    ...
    value: function _popsate() {
      ...
      if (this.cube.cubes.length > 0) {
        var _loop = function () {
          var cube = _this.cube.cubes[i];
          _libsGreensockSrcUncompressedTweenMax2['default'].to(cube.scale, .3, {
            x: 0.1,
            // y: 0.1,
            // z: 0.1,
            ease: Strong.CubicIn,
...
},{"../libs/greensock/src/uncompressed/TweenMax":3,"./Cube":4,"./LoadingPanel":5,"./Meteor":6,"./Planet":7,"./Raycaster":8,"./Scene":9,"./SpaceShuttle":11,"./Util":12}],11:[function(require,module,exports){
'use strict';
